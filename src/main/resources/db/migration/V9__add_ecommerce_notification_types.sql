...
-- Add comment to document all supported notification types
COMMENT ON COLUMN notifications.type IS 'Notification types: CHAT_MESSAGE, SYSTEM, ORDER_STATUS, PAYMENT, SUPPORT_REQUEST, NEW_ORDER, CART_ACTIVITY, ABANDONED_CART';
